...
{
    /// <summary>
    ///     A task to execute at sunset.
    /// </summary>
    public class SunsetTask : SunsetProcessor
    {
        private readonly ILogger<SunsetTask> _logger;

        public SunsetTask(ILogger<SunsetTask> logger
